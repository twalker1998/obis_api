...
class Occurrence(models.Model):
    ...
    eventdate = models.CharField(max_length=15, blank=True, null=True)
    ...
    georeferenceddate = models.CharField(max_length=15, blank=True, null=True)
    ...
    datelastmodified = models.CharField(max_length=15, blank=True, null=True)
    ...
    entrydate = models.CharField(max_length=15, blank=True, null=True)
