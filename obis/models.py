...
class Acctax(models.Model):
    ...
    variety                       = models.CharField(max_length=500, blank=True, null=True)
    forma                         = models.CharField(max_length=500, blank=True, null=True)
    ...
    usda_code                     = models.CharField(max_length=500, blank=True, null=True)
    ...
    sspscientificnameauthorship   = models.CharField(max_length=500, blank=True, null=True)
    varscientificnameauthorship   = models.CharField(max_length=500, blank=True, null=True)
    formascientificnameauthorship = models.CharField(max_length=500, blank=True, null=True)
...
class Occurrence(models.Model):
    ...
    recordedby                       = models.CharField(max_length=500, blank=True, null=True)
    ...
    behavior                         = models.CharField(max_length=500, blank=True, null=True)
    habitat                          = models.CharField(max_length=500, blank=True, null=True)
    sex                              = models.CharField(max_length=500, blank=True, null=True)
    lifestage                        = models.CharField(max_length=500, blank=True, null=True)
    associatedtaxa                   = models.CharField(max_length=500, blank=True, null=True)
    ...
    occurrenceremarks                = models.CharField(max_length=500, blank=True, null=True)
    taxonremarks                     = models.CharField(max_length=500, blank=True, null=True)
    ...
    catalognumber                    = models.CharField(max_length=500, blank=True, null=True)
    othercatalognumbers              = models.CharField(max_length=500, blank=True, null=True)
    typestatus                       = models.CharField(max_length=25, blank=True, null=True)
    recordnumber                     = models.CharField(max_length=500, blank=True, null=True)
    samplingprotocol                 = models.CharField(max_length=500, blank=True, null=True)
    preparations                     = models.CharField(max_length=500, blank=True, null=True)
    primary_data                     = models.CharField(max_length=500, blank=True, null=True)
    associatedreferences             = models.CharField(max_length=500, blank=True, null=True)
    ...
    geodeticdatum                    = models.CharField(max_length=10, blank=True, null=True)
    georeferencedby                  = models.CharField(max_length=500, blank=True, null=True)
    georeferenceddate                = models.DateField(blank=True, null=True)
    georeferenceremarks              = models.CharField(max_length=500, blank=True, null=True)
    georeferencesources              = models.CharField(max_length=500, blank=True, null=True)
    georeferenceverificationstatus   = models.CharField(max_length=500, blank=True, null=True)
    geom                             = models.TextField(blank=True, null=True)
    problem_with_record              = models.CharField(max_length=500, blank=True, null=True)
    previousidentifications          = models.CharField(max_length=500, blank=True, null=True)
    identificationverificationstatus = models.CharField(max_length=500, blank=True, null=True)
    identificationconfidence         = models.CharField(max_length=10, blank=True, null=True)
    identificationremarks            = models.CharField(max_length=500, blank=True, null=True)
    datelastmodified                 = models.DateField(blank=True, null=True)
    associatedoccurrences            = models.CharField(max_length=500, blank=True, null=True)
    associatedsequences              = models.CharField(max_length=500, blank=True, null=True)
    entby                            = models.CharField(max_length=500, blank=True, null=True)
    entrydate                        = models.DateField(blank=True, null=True)
    obs_gid                          = models.IntegerField(blank=True, null=True)
    mtr                              = models.TextField(blank=True, null=True)
    township                         = models.IntegerField(blank=True, null=True)
    ns                               = models.TextField(blank=True, null=True)
    range                            = models.IntegerField(blank=True, null=True)
    ew                               = models.TextField(blank=True, null=True)
    ...
    hiderecord                       = models.BooleanField(blank=True, null=True)
    hiderecordcomment                = models.CharField(max_length=500, blank=True, null=True)
    relationshipremarks              = models.CharField(max_length=500, blank=True, null=True)
    informationwitheld               = models.BooleanField(blank=True, null=True)
